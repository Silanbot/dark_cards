        ...
        <div class="inter__inner el-2">
            <section class="section-play play">
                    ...
                    <div class="play__block__row">
                        <div class="play__block__row__item">
                            <div class="play__block__row__item_img">
                                <svg
                                    :class="{active: isParamExists('thrown')}"
                                    class="fullimg"
                                    width="27"
                                    height="57"
                                    viewBox="0 0 75 102"
                            ...
                            <div class="play__block__row__item_img">
                                <svg
                                    :class="{active: isParamExists('transferable')}"
                                    class="fullimg"
                                    width="27"
                                    height="57"
                                    viewBox="0 0 69 102"
                            ...
                            <div class="play__block__row__item_img">
                                <svg
                                    :class="{active: isParamExists('neighbors')}"
                                    class="polimg"
                                    width="119"
                                    height="68"
                                    viewBox="0 0 119 68"
                                ...
                                <svg
                                    :class="{active: isParamExists('all')}"
                                    class="polimg"
                                    width="119"
                                    height="74"
                                    viewBox="0 0 119 74"
                            ...
                            <div class="play__block__row__item_img">
                                <svg
                                    :class="{active: isParamExists('cheaters')}"
                                    class="polimg"
                                    width="72"
                                    height="71"
                                    viewBox="0 0 72 71"
                                ...
                                <svg
                                    :class="{active: isParamExists('honest')}"
                                    class="polimg"
                                    width="96"
                                    height="50"
                                    viewBox="0 0 96 50"
                            ...
                            <div class="play__block__row__item_img">
                                <svg
                                    :class="{active: isParamExists('classic')}"
                                    class="defimg"
                                    width="74"
                                    height="66"
                                    viewBox="0 0 74 66"
                                ...
                                <svg
                                    :class="{active: isParamExists('draw')}"
                                    class="defimg"
                                    width="105"
                                    height="51"
                                    viewBox="0 0 105 51"
                        ...
                        <div class="play__block__row__item">
                            <div class="play__block__row__item_img">
                                <svg
                                    :class="{active: isParamExists('select_mode_1')}"
                                    class="defimg"
                                    width="27"
                                    height="39"
                                    viewBox="0 0 27 39"
                                ...
                                <svg
                                    :class="{active: isParamExists('select_mode_2')}"
                                    class="defimg"
                                    width="52"
                                    height="39"
                                    viewBox="0 0 52 39"
                ...
                <div class="play__down">
                    <a :href="selectMode == 1 ? '/filter3?cash' : 'filter3?coins'" class="play__down__block">
