    ...
    <section class="inter section section-inter">
        ...
        <div class="inter__inner el-2 blured">
            ...
            <section class="section-game game">
                <div id="cards">
                    ...
                    <img data-player="0" src="./sources/cards/back.svg">
                    <img data-player="1" src="./sources/cards/back.svg">
                    <img data-player="me" src="./sources/cards/7_of_clubs.svg">
                    <img data-player="0" src="./sources/cards/back.svg">
                    <img data-player="1" src="./sources/cards/back.svg">
                    <img data-player="me" src="./sources/cards/9_of_diamonds.svg">
                    <img data-player="0" src="./sources/cards/back.svg">
                    <img data-player="1" src="./sources/cards/back.svg">
                    <img data-player="me" src="./sources/cards/10_of_hearts.svg">
                    <img data-player="0" src="./sources/cards/back.svg">
                    <img data-player="1" src="./sources/cards/back.svg">
                    <img data-player="me" src="./sources/cards/jack_of_diamonds.svg">
                    <img data-player="0" src="./sources/cards/back.svg">
                    <img data-player="1" src="./sources/cards/back.svg">
                    <img data-player="me" src="./sources/cards/king_of_clubs.svg">
                    <img data-player="0" src="./sources/cards/back.svg">
                    <img data-player="1" src="./sources/cards/back.svg">
                    <img data-player="me" src="./sources/cards/ace_of_spades.svg">
        ...
        <footer class="footer" style="z-index: 2">
            <div class="footer__inner footer__inner_play">
                ...
                <div class="footer__button">Ваш ход</div>
...
export default {
    ...
    async mounted() {
        ...
        document.addEventListener('touchmove', e => {
            ...
            if (elem.dataset.player == 'me') activeCard = elem
        })
        document.addEventListener('touchend', e => {
            ...
            if (activeCard) {
                if (ty < window.innerHeight * 0.75) {
                    ...
                    activeCard.style.transform = `translate(${playerX - window.innerWidth / 4 + 25}px, ${playerY + window.innerHeight / 7 + 10}px) rotate(10deg)`
        ...
        let cardsCnt = document.querySelector('#mycards')
        let mycards = []
        ...
        function updateCards(t) {
            ...
            mycards.forEach((card, i) => {
                ...
                card.data.tx = cardsCnt.clientWidth / 2 + window.innerWidth * 0.1 + fromCenter * window.innerWidth * 0.8 / mycards.length
            ...
            if (touch && activeCard && ty < window.innerHeight * 0.75) {
                if (mycards.includes(activeCard))
                    mycards = mycards.filter(c => c != activeCard)
        ...
        function giveCards() {
            ...
            interval = setInterval(() => {
                let player = cards[i].dataset.player
                if (player == 'me') {
                    cards[i].style.width = '30vw'
                    cards[i].style.left = '-15vw'
                    cards[i].style.top = '-28vw'
                    mycards.push(cards[i])
                } else {
                    let playerRect = players[parseInt(player)].getBoundingClientRect()
                    let playerX = playerRect.x + playerRect.width / 2
                    let playerY = playerRect.y + playerRect.height / 2
                    cards[i].style.transform = `translate(${playerX}px, ${playerY}px)`
                    cards[i].style.width = '10vw'
                }
                countElem.innerHTML = --count
                if (++i == cards.length) return clearInterval(interval)
            }, 100)
        }
        ...
        function playerStep() {
            ...
            let playerX = playerRect.x + playerRect.width / 2
            let playerY = playerRect.y + playerRect.height / 2
            let card = document.querySelector('[data-player="1"]')
            gameCards.push(card)
            card.src = cardStep.src
            card.style.transform = `translate(${playerX - window.innerWidth / 4}px, ${playerY + window.innerHeight / 7}px)`
