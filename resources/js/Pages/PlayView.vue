...
<template>
    ...
    <section class="inter section section-inter">
            ...
            <section class="section-game game">
                ...
                <div class="game__cart">
                    <div class="game__cart__cold">
                        <div class="game__cart__cold__count">6</div>
                        ...
                        <div class="game__cart__cold__two">
                            <img class="game__cart__cold__two__main" src="./sources/cart-center.png" alt="" />
                            <img class="game__cart__cold__two__second" src="./sources/cart-center.png" alt="" />
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div id="mycards">
            <img src="./sources/mycards.png" alt="" />
        </div>
                    ...
                    <div class="footer__btns__row">
                        <div class="footer__btns__row__cart">
                            ...
                            <svg width="75" height="87" viewBox="0 0 75 87" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.612372" y="16.3536" width="57" height="70" rx="6.5" transform="rotate(-15 0.612372 16.3536)"
                        ...
                        <div class="footer__btns__row__cart">
                            ...
                            <svg width="75" height="85" viewBox="0 0 75 85" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="-0.612372" y="0.353553" width="57" height="70" rx="6.5"
                                      transform="matrix(-0.965926 -0.258819 -0.258819 0.965926 73.2861 15.8536)" fill="#321111"
                                      stroke="#EB3D3D" />
                                <rect x="0.612372" y="16.3536" width="57" height="70" rx="6.5" transform="rotate(-15 0.612372 16.3536)"
                                      fill="#321111" stroke="#EB3D3D" />
                                <path opacity="0.5"
                        ...
                        <div class="footer__btns__row__cart">
                            ...
                            <svg width="93" height="92" viewBox="0 0 93 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="-0.639606" y="0.301503" width="57" height="70" rx="6.5"
                                      transform="matrix(-0.941109 -0.338104 -0.338104 0.941109 91.4502 24.4114)" fill="#321111"
                                      stroke="#EB3D3D" />
                                <rect x="-0.516896" y="0.482513" width="57" height="70" rx="6.5"
                                      transform="matrix(-0.999409 -0.0343826 -0.0343826 0.999409 76.3894 9.97665)" fill="#321111"
                                      stroke="#EB3D3D" />
                                <rect x="0.612372" y="15.365" width="57" height="70" rx="6.5" transform="rotate(-15 0.612372 15.365)"
                                      fill="#321111" stroke="#EB3D3D" />
