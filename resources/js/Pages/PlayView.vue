...
<template>
    ...
    <section class="inter section section-inter">
        <div class="inter__header inter__header_play">
            <div class="inter__monet inter__monet_icon" v-for="setting of room.settings" :key="setting.id">
                <svg v-if="setting.name === 'thrown'" width="75" height="102" viewBox="0 0 75 102" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="gostroke"
